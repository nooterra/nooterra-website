    ...
    <div className="max-w-6xl mx-auto space-y-32">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center relative">
        <div className="space-y-6">
          <div className="text-9xl font-bold text-substrate absolute -left-12 -top-12 -z-10 opacity-20 select-none pointer-events-none">01</div>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center relative">
        <div className="glass-panel p-8 rounded-xl h-64 flex items-center justify-center relative">
           ...
           <div className="flex gap-4 items-center">
              <div className="w-12 h-12 border border-execute/50 rounded flex items-center justify-center text-execute bg-execute/5">A</div>
              <div className="h-px w-16 bg-execute animate-pulse"></div>
              <div className="w-12 h-12 bg-execute/10 border border-execute text-primary rounded flex items-center justify-center shadow-[0_0_15px_rgba(124,58,237,0.2)]">B</div>
              <div className="h-px w-16 bg-execute animate-pulse"></div>
              <div className="w-12 h-12 border border-execute/50 rounded flex items-center justify-center text-execute bg-execute/5">C</div>
           </div>
        </div>
        <div className="space-y-6 md:-order-1 relative">
        <div className="text-9xl font-bold text-substrate absolute -right-12 -top-12 -z-10 opacity-20 select-none pointer-events-none">02</div>
